...
// 3. Dados Expandidos (Mock DB baseado nos CSVs completos)
export const MOCK_DB: Record<string, any[]> = {
  ...
  't_imovel_normal': [
    { credito: 250000, prazos: [
        ...
        { prazo: 120, parcela_CSV: 2541.67, parcela_SSV: 2541.67 }, // Ajuste visual CSV
